...
describe('buildUserPrompt', () => {
  ...
  it('includes campaign name', () => {
    expect(buildUserPrompt(mockCampaign, mockCreator)).toContain('Summer Campaign')
  })
  ...
  it('includes application message', () => {
    expect(buildUserPrompt(mockCampaign, mockCreator)).toContain('I love your brand!')
  })
  ...
  it('requests a recommendation field in the JSON schema', () => {
    expect(buildUserPrompt(mockCampaign, mockCreator)).toContain('recommendation')
  })
})
