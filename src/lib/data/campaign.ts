...
export const CAMPAIGN: Campaign = {
  ...
  campaignGoal: 'Drive awareness and trial for a new SPF lip balm among Gen Z consumers.',
  targetAudience: 'Gen Z women, beauty lovers, college students, skincare beginners',
